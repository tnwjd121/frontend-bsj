...
// noImplicitAny
// : 타입이 지정되지 않은 값은 Typescript 컴파일러가 자동으로any타입을 부여하는 동작
// : TS 컴파일러가 noImplicitAny를 활성화하느 경우
...
// referrence에 name이라는 설명을 가진 심볼을 생성
