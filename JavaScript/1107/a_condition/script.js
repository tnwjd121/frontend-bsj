...
if (number > 0) console.log("The number is postive"); else console.log("The number is not postive");
...
// 위의 값을 제외하고는 true값을 반환하기 때문에 변수가 참인지 또는 값이 존재하는지 테스트하기 위해서 변수 이름 그 자체를 사용할 수 있음.
...
// switch문은 여러 가지 가능한 케이스 중 하나를 선택하여 해당하는 코드 블록을 실행하는 제어 구조
...
number = 15;
let message =
number > 10 ? 'The number is greater than 10' : 'The number is not greater than 10';
