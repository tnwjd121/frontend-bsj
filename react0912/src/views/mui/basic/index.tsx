...
//! MUI 테마 및 디자인 정의
//createTheme 함수를 사용하여 사용자 정의 테마생성
...
export default function index() {
  return (
    <>
      ...
      {/* sx 속성 사용 */}
      <Box sx = {{color: 'primary.contrastText', backgroundColor: 'primary.main', width : 100, borderRadius: 8, '@media (min-width: 600px)': {width: 250, fontSize: 40},
    '&:hover' : {bgcolor: 'primary.light'}, display: 'flex', justifyContent:'center', m:10, p: 10, maxWidth: 300, maxHeight: 150
    }}>
        This is a box
      </Box>
    </>
